...
async function main() {
  ...
  // Try calling RPC with explicit JWT claim setting via PostgREST headers?
  // Actually, let's just test the RPC directly with the service role key after setting a fake JWT
